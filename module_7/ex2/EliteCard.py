...
class EliteCard(Card, Combatable, Magical):
    ...
    def cast_spell(self, spell_name: str, t: list) -> dict:
        ...
        if spell_name == 'Heal' and t and hasattr(t[0], 'health'):
            t[0].health = min(t[0].max_health, t[0].health + 3)

        return {
            'caster': self.name,
            'spell': spell_name,
            'targets': [t.name if hasattr(t, 'name') else str(t) for t in t],
            'mana_used': 2,
